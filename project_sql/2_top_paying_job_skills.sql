...
/* 
In this Particular Query, I have already found out that what are the top paying jobs,
 so by using the common table expression, I just used that data, to inner join skills from the skills
 table, to make sure that I will be able to find out the skills of the top paying jobs
 */
